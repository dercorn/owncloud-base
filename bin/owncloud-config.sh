...
# Install ownCloud
occ maintenance:install --database "mysql" --database-name "$OWNCLOUD_DB_NAME"  --database-host "mariadb" --database-user "root" --database-pass "$MARIADB_ENV_MARIADB_ROOT_PASSWORD" --admin-user "admin" --admin-pass "password" --data-dir "/mnt/data/files"
